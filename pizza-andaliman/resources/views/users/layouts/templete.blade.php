  ...
  <header id="header" class="fixed-top header">
    <div class="container-fluid container-xl d-flex align-items-center justify-content-lg-between">
        ...
        <nav id="navbar" class="navbar order-last order-lg-0">
            <ul>
                <li><a class="nav-link scrollto" href="{{ request()->routeIs('product','addtocart','singleproduct','placeorder', 'peddingreservations', 'peddingorders','userprofile','feedback','category','checkout','history','historidetil') ? route('home') : '#hero' }}">Beranda</a></li>
                <li><a class="nav-link scrollto" href="{{ request()->routeIs('product','addtocart','singleproduct','placeorder', 'peddingreservations', 'peddingorders','userprofile','feedback','category','checkout','history','historidetil') ? route('home').'#events' : '#events' }}">Layanan</a></li>
                <li><a class="nav-link scrollto" href="{{ request()->routeIs('addtocart','singleproduct','placeorder', 'peddingreservations', 'peddingorders','userprofile','feedback','category','checkout','history','historidetil') ? route('home').'#product' : '#product' }}">Produk</a></li>
                <li><a class="nav-link scrollto" href="{{ request()->routeIs('product','addtocart','singleproduct','placeorder', 'peddingreservations', 'peddingorders','userprofile','feedback','category','checkout','history','historidetil') ? route('home').'#book-a-table' : '#book-a-table' }}">Reservasi</a></li>
                <li><a class="nav-link scrollto" href="{{ request()->routeIs('product','addtocart','singleproduct','placeorder', 'peddingreservations', 'peddingorders','userprofile','feedback','category','checkout','history','historidetil') ? route('home').'#testimonials' : '#testimonials' }}">Feedback</a></li>
                <li>
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <li><a class="dropdown-item" href="{{ request()->routeIs('product','addtocart','singleproduct','placeorder', 'peddingreservations', 'peddingorders','userprofile','feedback','category','checkout','history','historidetil') ? route('home').'#gallery' : '#gallery' }}">Galeri</a></li>
                            <li><a class="dropdown-item" href="{{ request()->routeIs('product','addtocart','singleproduct','placeorder', 'peddingreservations', 'peddingorders','userprofile','feedback','category','checkout','history','historidetil') ? route('home') .'#contact': '#contact' }}">Kontak</a></li>
                        </ul>
                    </div>
                </li>
            </ul>
