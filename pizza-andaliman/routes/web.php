...
Route::controller(ClientController::class)->group(function(){
    ...
    Route::post('upload-payment-proof/{id}', 'uploadPaymentProof')->name('uploadPaymentProof');
    Route::get('/payment/{id}', 'showPaymentForm')->name('payment');
    Route::post('/payment/upload', 'PaymentController@uploadPaymentProof')->name('uploadPaymentProof');
